/* jQuery based image slider
 /* TMSlider 0.3 */
(function($,undefined){
	var _TMS1=window._TMS1=$.fn._TMS1=function(_){
		_=_||{}
		_=$.extend(clone(_TMS1),_TMS1.presets[_.preset],_)
	...
	$.extend(_TMS1,{
		...
		pic:'pic',
		mask:'mask',
		paginationCl:'paginationSlider1',
		currCl:'current',
		pauseCl:'paused',
		bannerCl:'banner',
		...
		changeFu:function(n){
			...
			var _fu=function(){
				...
				if(_.preset_!=_.preset)
					_.du=_.duration,
						_.ea=_.easing,
						$.extend(_,_TMS1.presets[_.preset]),
						_.duration=_.du,
						_.easing=_.ea,
						_.preset_=_.preset
				_.sliceFu()
		...
		paginationFu:function(){
			var _=this
			if(_.paginationSlider1===false)
				return false
			if(_.paginationSlider1===true)
				_.pags=$('<ul></ul>')
