...
(function($,undefined){
	...
	$.extend(_TMS,{
		...
		paginationFu:function(){
			var _=this					
			if(_.paginationSlider===false)
				return false
			if(_.paginationSlider===true)
				_.pags=$('<ul></ul>')
